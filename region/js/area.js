...
// 		areaCont += '<li class="ft13" onClick="selectP(' + i + ');">' + province[i] + '</li>';
// 	}
// 	console.log(city);
...
// 	areaCont = "";
// 	areaList.html("");
// 	for (var j = 0; j < city[p]; j++) {
// 		areaCont += '<li class="ft13" onClick="selectC(' + p + ',' + j + ');">' + city[p][j] + '</li>';
// 	}
// 	areaList.html(areaCont);
// 	$("#areaBox").scrollTop(0);
...
// 		areaCont += '<li class="ft13" onClick="selectD(' + p + ',' + c + ',' + k + ');">' + district[p][c][k] + '</li>';
// 	}
// 	areaList.html(areaCont);
// 	$("#areaBox").scrollTop(0);
// 	var sCity = city[p][c];
